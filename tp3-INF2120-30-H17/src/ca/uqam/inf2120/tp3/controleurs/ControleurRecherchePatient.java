        ...
        if(source == this.uneVue.getRdbtnTous()){
        	...
        	if(!FillData())
        	{
        		JOptionPane.showMessageDialog(this.uneVue,
    					"Aucun patient n'existe dans le syst�me",
    					"SPT- Information",
        	...
        	if(!uneVue.getTfRecherche().getText().isEmpty())
        	{
	        	...
	        	if(this.uneVue.getRdbtnEgalepiorite().isSelected()){
	        		...
	        		try{
		            	...
		            	{
		            		JOptionPane.showMessageDialog(this.uneVue,
		        					"Aucun patient n'a la priorité " + priorite + " dans le syst�me ",
		        					"SPT- Information",
		        					JOptionPane.INFORMATION_MESSAGE);
		            	}
	        	...
	        	if(this.uneVue.getRdbtnInfpiorite().isSelected()){
	        		...
	        		try{
		            	...
		            	{
		            		JOptionPane.showMessageDialog(this.uneVue,
		        					"Aucun patient n'a une priorité inférieure à " + priorite + " dans le syst�me ",
		        					"SPT- Information",
		        					JOptionPane.INFORMATION_MESSAGE);
		            	}
	        		} catch (NumberFormatException ex ) { 
	        	...
	        	if(this.uneVue.getRdbtnSuppiorite().isSelected()){
	        		...
	        		try{
		            	...
		            	{
		            		JOptionPane.showMessageDialog(this.uneVue,
		        					"Aucun patient n'a une priorité supérieure à " + priorite + " dans le syst�me ",
		        					"SPT- Information",
		        					JOptionPane.INFORMATION_MESSAGE);
		            	}
	        		} catch (NumberFormatException ex ) { 
