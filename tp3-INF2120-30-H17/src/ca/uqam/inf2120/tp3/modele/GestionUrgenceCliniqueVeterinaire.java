...
public class GestionUrgenceCliniqueVeterinaire {
	 ...
	 * @param Priorite
	 * @param typeRecherche
	 * @return - Si typeRecherche = 1 retourne la list des patient dont la
	 *         priorité est superieur a celle passé en paramètre - Si
	 *         typeRecherche = 0 retourne la list des patient dont la priorité
	 *         est égale a celle passé en paramètre - Si typeRecherche = -1
	 *         retourne la list des patient dont la priorité est inferieur a
	 *         celle passé en paramètre - null si aucun patient n'a été trouvé
	 */
	 ...
	 * 
	 * @param identifiant
	 * @return patient : le patient ayant l'indentifiant recherché ou null si
